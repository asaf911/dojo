//
//  PlayableSession.swift
//  Dojo
//
//  Protocol defining the common interface for all playable meditation session types.
//

import Foundation
import Combine

/// Enum defining the type of playable session
enum SessionType {
...
/// Protocol that all playable meditation session types must implement
protocol PlayableSession: ObservableObject {
